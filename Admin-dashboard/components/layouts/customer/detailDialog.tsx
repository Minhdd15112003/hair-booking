...
import { deleteCustomer } from '@/app/api/core/customer';
...
export function DetailsDialog({ customer, onSuccess }: CustomerDetailsDialogProps) {
    ...
    return (
        <DialogContent className="sm:max-w-[800px] sm:max-h-[600px] w-full h-full">
            ...
            <div className="flex justify-end space-x-2 mt-6">
                ...
                <CustomAlertDialog
                    triggerText="Chặn"
                    title="Bạn có chắc muốn chặn khách hàng này"
