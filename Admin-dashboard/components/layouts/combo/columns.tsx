...
export const Combocolumns: ColumnDef<TComboResponse>[] = [
    {
        accessorKey: 'index',
        header: 'STT',
...

    {
        ...
        header: () => <div className="">Thông tin</div>,
    ...
    //                     <DropdownMenuItem onClick={() => navigator.clipboard.writeText(combo.id)}>
    //                         Sao chép ID combo
    //                     </DropdownMenuItem>
    //                     <DropdownMenuSeparator />
    //                     <Dialog>
    //                         <DialogTrigger asChild>
    //                             <Button variant="ghost">Xem chi tiết combo</Button>
    //                         </DialogTrigger>
    //                         <DetailsDialog product={combo} />
    //                     </Dialog>
    //                 </DropdownMenuContent>
    //             </DropdownMenu>
    //         );
