...
export function StylistTable<TData, TValue>({ columns, data, onSuccess }: DataTableProps<TData, TValue>) {
        ...
        <Dialog>
            <div className="w-full">
                <div className="flex items-center py-4">
                    <Input
                        placeholder="Tìm tên Nhà tạo mẫu..."
                        value={(table.getColumn('full_name')?.getFilterValue() as string) ?? ''}
                        onChange={(event) => table.getColumn('full_name')?.setFilterValue(event.target.value)}
                        className="max-w-sm"
                    />
                    <div className="ml-auto">
                        <StylistForm onSuccess={onSuccess} />
                    </div>
                </div>
            ...
            <div className="p-4 pb-0">
                <DetailsDialog stylist={selectedStylist} onSuccess={onSuccess} />
            </div>
        </Dialog>
    );
}
