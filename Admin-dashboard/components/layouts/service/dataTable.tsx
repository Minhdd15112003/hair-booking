...
import ServiceForm from './formData'; // Import ServiceForm
...
export function ServiceTable<TData, TValue>({ columns, data, onSuccess }: DataTableProps<TData, TValue>) {
    ...
    return (
        <Dialog>
            <div className="w-full">
                <div className="flex items-center py-4">
                    ...
                    <div className="ml-auto">
                        {/* Truyền onSuccess vào ServiceForm */}
            ...
            <div className="p-4 pb-0">
                <DetailsDialog product={selectedService} onSuccess={onSuccess} />
            </div>
        </Dialog>
    );
}
